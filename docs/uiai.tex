...
\usepackage[style=nature, citestyle=authoryear, backend=biber,date=year]{biblatex}
...
\begin{abstract}
  ...
  practical.  Also, they offer numeric expressions of confidence for
  their answers.  The general principle is to describe multiple
  possible causal models with specific consequences and test those
...
Also in medicine, observational data is plentiful and finding
